...
* The original package name 'com.example.oviva.insurance-activation-code' is invalid and this project uses 'com.example.oviva.insuranceactivationcode' instead.
